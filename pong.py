...
def draw(canvas):
    ...
    wall_collisions() # control collisions with top/bottom walls
    in_gutter() # test if ball touches left/right gutters  
    update_paddles() # update paddles 
    
    # draw scores
    canvas.draw_text(str(player1_score) + " : " + str(player2_score), 
                     [WIDTH / 2 - 45, 60], 50, "White")
